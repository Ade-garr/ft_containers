...
/*   Updated: 2021/12/07 03:05:19 by ade-garr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// //////////////////////////////////////////////////////////////
	...
	myvec.insert(myvec.begin() + 25000000, vec1.begin(), vec1.end());
	
	diff_mine1 = std::time(0) - begin;

	myvec.clear();
	begin = std::time(0);
	stdvec.insert(stdvec.begin() + 25000000, vec1.begin(), vec1.end());
	diff_std1 = std::time(0) - begin;
